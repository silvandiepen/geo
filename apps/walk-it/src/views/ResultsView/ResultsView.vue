<template>
  <div class="container walk-results">
    <section>
      <div class="walk-results__hero">
        <Icon name="trophy" class="walk-results__icon" />
      ...
      <div class="walk-results__actions">
